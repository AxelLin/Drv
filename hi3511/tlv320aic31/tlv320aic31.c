...
void soft_reset(unsigned int chip_num)
{
       /*soft reset*/ 
        ...
        /*sample*/
    	tlv320aic31_write(IIC_device_addr[chip_num], 2,  0x22);
  
        /*left and right DAC open*/	
        tlv320aic31_write(IIC_device_addr[chip_num], 7,  0xa);
        
        /*ctrl mode*/
        tlv320aic31_write(IIC_device_addr[chip_num], 8,  0x20);        
                
        /*Audio Serial Data Interface Control*/	
        tlv320aic31_write(IIC_device_addr[chip_num], 9,  0x7);
        ...
        /*out path select*/	
        tlv320aic31_write(IIC_device_addr[chip_num], 41, 0xa1);    
...
static int tlv320aic31_device_init(unsigned int num)
{
        ...
        gpio_i2c_write(IIC_device_addr[0],0x2,0xaa);
