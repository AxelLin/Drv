...
/* l44613 add for version info */
#define OSDRV_MODULE_VERSION_STRING "LINUX_2_6_14-M07C0303B0103 @Hi3511v110_OSDrv_1_0_0_7 2009-05-20 20:41:32"
static int hiversion_read_proc(char *page, char **start, off_t off,
				 int count, int *eof, void *data)
{
	int len;

	len = sprintf(page, "%s\n", OSDRV_MODULE_VERSION_STRING);
	return proc_calc_metrics(page, start, off, count, eof, len);
}
...
void __init proc_misc_init(void)
{
	...
	/* l44613 add for version info */
	printk(KERN_INFO "HI_VERSION=" OSDRV_MODULE_VERSION_STRING "\n");
}
