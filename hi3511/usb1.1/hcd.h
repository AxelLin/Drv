...
//add by c54122
//#ifdef CONFIG_USB_INVENTRA_HCD
/*-------------------------------------------------------------------------*/
/*make a statement for otg_controller*/
extern int otg_usb_register_bus(struct usb_bus *bus);
extern void otg_usb_deregister_bus (struct usb_bus *bus);
extern int otg_register_root_hub (struct usb_device *usb_dev, struct usb_hcd *hcd);
//#endif
