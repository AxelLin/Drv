...
static int          dmac_channel[CHANNEL_NUM]={0,1,2,3,4,5,6,7};
...
dmac_peripheral  g_peripheral[DMAC_MAX_PERIPHERALS]=
{
#if  PERIPHCTRL5
    	/*periphal 0,I2C_rx*/
    	{ DMAC_OTG20_DMA4_REQ,(unsigned int*)OTG20_DMA4_DATA_REG,OTG20_DMA4_CONTROL,OTG20_DMA4_CONFIG},
    	/*periphal 1,I2C_tx*/
    	{ DMAC_OTG20_DMA1_REQ,(unsigned int*)OTG20_DMA1_DATA_REG,OTG20_DMA1_CONTROL,OTG20_DMA1_CONFIG } ,
#else  
    	/*periphal 0,I2C_rx*/
    	{ DMAC_I2C_RX_REQ,(unsigned int*)I2C_DATA_REG,I2C_RX_CONTROL,I2C_RX_CONFIG},
    	/*periphal 1,I2C_tx*/
    	{ DMAC_I2C_TX_REQ,(unsigned int*)I2C_DATA_REG,I2C_TX_CONTROL,I2C_TX_CONFIG } ,
#endif
    	/*periphal 2,SIO_0_rx*/
    	...
    	/*periphal 4,RESERVED5*/
    	{ DMAC_SIO1_RX_REQ,(unsigned int*)SIO1_RX_FIFO,SIO1_RX_CONTROL,SIO1_RX_CONFIG}, 
        
        /*periphal 5,SPDIF_tx*/
        { DMAC_SPDIF_TX_REQ,(unsigned int*)SPDIF_DATA_REG,SPDIF_TX_CONTROL,SPDIF_TX_CONFIG},    	
        /*periphal 6,ATA_tx*/
        { DMAC_ATAH0_REQ,(unsigned int*)ATAH0_DATA_REG,ATAH0_CONTROL,ATAH0_CONFIG},
        /*periphal 7,ATA_RX*/
        { DMAC_ATAH1_REQ,(unsigned int*)ATAH1_DATA_REG,ATAH1_CONTROL,ATAH1_CONFIG},
        /*periphal 8,SSP_RX*/
...
#if  PERIPHCTRL5
        /*periphal 10,RESERVED3*/
        { DMAC_OTG20_DMA3_REQ,(unsigned int*)OTG20_DMA3_DATA_REG,OTG20_DMA3_CONTROL,OTG20_DMA3_CONFIG},
        /*periphal 11,RESERVED2*/
        { DMAC_OTG20_DMA0_REQ,(unsigned int*)OTG20_DMA0_DATA_REG,OTG20_DMA3_CONTROL,OTG20_DMA0_CONFIG},
#else
        /*periphal 10,RESERVED3*/
        { DMAC_USB11_RX_REQ,(unsigned int*)USB11_RX_REG,USB11_RX_CONTROL,USB11_RX_CONFIG},
        /*periphal 11,RESERVED2*/
        { DMAC_USB11_TX_REQ,(unsigned int*)USB11_TX_REG,USB11_TX_CONTROL,USB11_TX_CONFIG},
#endif
        /*periphal 12,RESERVED1*/
        { DMAC_MMC_RX_REQ,(unsigned int*)MMC_RX_REG,MMC_RX_CONTROL,MMC_RX_CONFIG},
        /*periphal 13,RESERVED0*/
        { DMAC_MMC_TX_REQ,(unsigned int*)MMC_TX_REG,MMC_TX_CONTROL,MMC_TX_CONFIG},
#ifdef UART_DMA_USED        
    	/*periphal 14,UART0_RX*/
    	{ DMAC_UART0_RX_REQ,(unsigned int*)UART0_DATA_REG,UART0_RX_CONTROL,UART0_RX_CONFIG} ,
    	/*periphal 15,UART0_TX*/
    	{ DMAC_UART0_TX_REQ,(unsigned int*)UART0_DATA_REG,UART0_TX_CONTROL,UART0_TX_CONFIG} 
#else
    	/*periphal 14,UART0_RX*/
    	{ DMAC_PERIPHERIAL1_REQ,(unsigned int*)PERIPHERIAL1_DATA_REG,UART0_RX_CONTROL,UART0_RX_CONFIG} ,
    	/*periphal 15,UART0_TX*/
    	{ DMAC_PERIPHERIAL2_REQ,(unsigned int*)PERIPHERIAL2_DATA_REG,UART0_TX_CONTROL,UART0_TX_CONFIG} 
#endif
 ...
 */
static   irqreturn_t dmac_isr(int irq, void * dev_id, struct pt_regs *regs)
{  
    	unsigned int channel_status, tmp_channel_status, channel_tc_status, channel_err_status;
    	unsigned int i ;
    	...
    	{
        	tmp_channel_status = (channel_status >> i) & 0x01;
        	if(tmp_channel_status == 0x01)
        	{
            		CLR_INT(i);
...
{   
    	...
    	if(request_irq(17,&dmac_isr,SA_INTERRUPT,"Hisilicon Dmac",NULL))
    	{
